...
export class History extends React.Component {
  ...
  handleChangeCurrencySell = (event) => {
    if (event.target.value === this.state.currencySelectedBuy) {
      ...
      this.prepareChartData(
        event.target.value,
        this.state.currencySelectedSell,
      ...
      this.prepareChartData(
        event.target.value,
        this.state.currencySelectedBuy,
        this.state.timeSelected,
      );
    }
  };
  ...
  render() {
    return (
      <StyledDiv>
        <InternalContainer>
          {this.props.data.userInfo.Login.logged && (
            <UserHistory history={this.props.data.userInfo.history} />
          )}
