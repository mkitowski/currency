...
import StyledInputFull from '../../Styled/StyledInputFull/StyledInputFull';
    ...
    return (
      <StyledContainer top={'15%'}>
        ...
        <form onSubmit={this.validation}>
          ...
          />
          {this.state.error && (
            <StyledLabel>Chyba pomyliłeś hasło lub login</StyledLabel>
          )}
          {this.state.loading ? (
            <StyledButton disabled>{<CircleProgress />}Czekaj </StyledButton>
          ) : (
